...
<main id="contents" class="clr-fix">
        <section class="page" id="page2">
            ...
            <div class="tb_wrap">
				...
				<div class="page_wrap">
					<h3 class="page_title">자유게시판 글 수정</h3>
						<form action="${path0 }/EditProBoard.do" method="post">
						<table class="table">
							 <tbody>
							 	<tr>
							 		<th><label for="title">글 번호</label></th>
							 		<td><input type="text" name="no" id="no" value="${board.no }" readonly></td>
							 	</tr>
							 	<tr>
							 	...
							 	<tr id="tr_content">
							 		...
							 		<td>
							 			<textarea name="content" id="content" rows="22">${board.content }</textarea>
							 		</td>
							 	</tr>
							 	<tr>
							 		<th>작성자</th>
