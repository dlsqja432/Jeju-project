...
<main id="contents" class="clr-fix">
        <section class="page" id="page2">
            ...
            <div class="tb_wrap">
				...
				<div class="page_wrap">
					<h3 class="page_title">자료 수정</h3>
						<form action="${path0 }/EditProData.do" method="post">
						<table class="table">
							 <tbody>
							 	<tr>
							 		<th><label for="title">글 번호</label></th>
							 		<td><input type="text" name="no" id="no" value="${data.no }" readonly></td>
							 	</tr>
							 	<tr>
							 	...
							 	<tr id="tr_content">
							 		...
							 		<td>
							 			<textarea name="content" id="content" rows="22">${data.content }</textarea>
							 		</td>
							 	</tr>
							 	<tr>
									...
									<td>
										...
										<input type="text" class="form-control" name="datafile" id="datafile" value="${data.datafile }" readonly />
									</td>
								</tr>
							 	<tr>
							 		<th>작성일시</th>
