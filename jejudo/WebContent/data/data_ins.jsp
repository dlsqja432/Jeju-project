...
.table input#title { font-size:16px; width:774px; height:50px; outline: none; padding-left:10px;
					...
					<form action="${path0 }/DataIns.do" method="post" enctype="multipart/form-data">
						...
						<div class="btn-group">
							<c:if test="${sid.equals('admin') }">
			 					<button type="submit" class="btns">자료 등록</button>
			 				</c:if>
			 				<a href="${path0 }/DataList.do" class="btns">자료 목록</a>
						</div>
					</form>
				</div>
            </div> 
