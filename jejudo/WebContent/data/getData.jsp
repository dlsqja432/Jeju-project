...
<main id="contents" class="clr-fix">
        <section class="page" id="page2">
            ...
            <div class="tb_wrap">
                <h2 class="page_title" id="page_title1">자료실</h2>
                <ol class="breadcrumb">
				...
				<div class="page_wrap">
					<h3 class="page_title">자료 상세보기</h3>
					<div>
						<table class="table">
							 <tbody>
							 	<tr>
							 	...
							 	<tr>
							 		<th>글 제목</th>
							 		<td id="td_title">${data.title }</td>
							 	</tr>
							 	<tr id="tr_content">
							 		<th id="th_content">글 내용</th>
							 		<td id="td_content">${data.content }</td>
							 	</tr>
							 	<tr>
							 		<th>자료 내용</th>
							 		<td>${data.datafile }</td>
						...
						<div class="btn-group">
							<c:if test="${sid.equals('admin') }">
			 					<a href="${path0 }/data/data_ins.jsp" class="btns">글 등록</a>
			 					<a href="${path0 }/EditData.do?no=${data.no }" class="btns">글 수정</a>
			 					<a href="${path0 }/DelData.do?no=${data.no }" class="btns_red">글 삭제</a>
			 				</c:if>
			 				<a href="${path0 }/DataList.do" class="btns">글 목록</a>
						</div>
					</div>
				</div>
            </div>
