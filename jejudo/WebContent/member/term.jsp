...
개인정보 보호법 제15조에 따라 본 개인정보 수집ㆍ이용에 대한 동의를 거부할 수 있으나, 이 경우 회원가입이 제한됩니다.
			...
			<hr>
			<div class="btn-group">
				<button type="submit" onclick="all_check()" class="btn btn-secondary">전체 약관에 동의</button>
			</div>
			<div class="btn-group">	
				<button type="reset" onclick="term_check()" class="btn btn-secondary">다음 단계</button>
			</div>
		</div>
		<script>
