...
<main id="contents" class="clr-fix">
        <section class="page" id="page2">
            ...
            <div class="tb_wrap">
				...
				<div class="page_wrap">
					<h3 class="page_title">공지사항 수정</h3>
						<form action="${path0 }/EditProNotice.do" method="post">
						<table class="table">
							 <tbody>
							 	<tr>
							 		<th><label for="title">글 번호</label></th>
							 		<td><input type="text" name="no" id="no" value="${noti.no }" readonly></td>
							 	</tr>
							 	<tr>
							 		<th><label for="title">제목</label></th>
							 		<td>
							 			<input type="text" name="title" id="title" value="${noti.title }">
							 		</td>
							 	</tr>
							 	<tr id="tr_content">
							 		<th id="th_content"><label for="content">글 내용</label></th>
							 		<td>
							 			<textarea name="content" id="content" rows="22">${noti.content }</textarea>
							 		</td>
							 	</tr>
							 	<tr>
							 		<th>작성일시</th>
